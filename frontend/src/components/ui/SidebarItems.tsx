...
const SidebarItems = (props: SidebarItemType) => {
  return (
    <div className="py-1 cursor-pointer px-2 flex gap-3 items-center bg-slate-200 my-3 rounded-lg hover:bg-secondary transition-shadow duration-1000 ease-in ">
